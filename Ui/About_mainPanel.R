...
fluidRow(
  ...
  column(12, 
         HTML(
           ...
           The <i>CBB Taxonomy App</i> is a web application useful to compare a owner taxonomy to 
           those contained in several public databases. 
           
           <h1>The Balearic Biodiversity Centre</h1>
           
           The Balearic Biodiversity Centre (<b> CBB </b>) is a scientific initiative that aims to generate knowledge
